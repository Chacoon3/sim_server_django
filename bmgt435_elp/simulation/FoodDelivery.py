...
class FoodDeliveryResult(SimulationResult):
    ...
    __data_dict = dict(
        hub = "delivery hub index",
        week = "week index",
        prior_inventory = "inventory before the week starts",
        post_inventory = "inventory after the week ends",
        demand = "the observed demand at the hub in the week, measured by the number of orders",
        supply = "the realized supply at the hub in the week, measured by the number of orders",
        shortage_count = "the number of orders that failed to be covered by the supply",
        shortage_cost = "the total shortage penalty incurred by the hub in the week, measured by the total value of the missed orders",
        revenue = "the total revenue generated by the hub in the week, measured by the total value of the orders that were covered",
        holding_cost = "the total holding cost incurred by the hub in the week, measured by the total value of the inventory at the end of the week",
        fixed_cost = "the fixed cost incurred by the hub in the week, measured in dollar amount",
        iteration = "the index of the iteration in the simulation run"
    )
    ...
    def asFileStream(self) -> io.BytesIO:
        ...
        data_dict_sheet = wb.create_sheet('data_dictionary')
        data_dict_sheet.append(['Column Name', 'Description'])
        for k, v in FoodDeliveryResult.__data_dict.items():
            data_dict_sheet.append([k, v])
